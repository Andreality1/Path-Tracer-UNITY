...
public class PathTracerHost11 : MonoBehaviour
{
    ...
    [SerializeField] private LightEmissionMode lightMode = LightEmissionMode.PolychromaticSpectrum;
    ...
    [Tooltip("Used if Monochromatic Laser mode is selected")]
    [Range(380f, 780f)]
    [SerializeField] private float lightDiscreteWavelength = 532.0f;

    [Tooltip("Used if Polychromatic Spectrum mode is selected. Set to White for full spectrum dispersion.")]
    [ColorUsage(false, true)]
    [SerializeField] private Color lightColorPicker = Color.white;
