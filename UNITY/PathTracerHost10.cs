...
public class PathTracerHost10 : MonoBehaviour
{
    ...
    [Header("Sphere Light Settings")]
    [SerializeField] private Vector3 lightCenter = new Vector3(-2.5f, 3.0f, 5.0f);
    [SerializeField] private float lightRadius = 0.15f;
    [Range(380f, 780f)]
    [SerializeField] private float lightWavelength = 532.0f;
    [SerializeField] private float lightIntensity = 150.0f;

    [Header("Prism Transform Settings")]
    [SerializeField] private Vector3 prismPosition = new Vector3(0.0f, 1.5f, 5.0f);
    [SerializeField] private Vector3 prismRotation = new Vector3(0.0f, 0.0f, 45.0f); // Euler angles
    ...
    private static readonly int CameraToWorldMatrixID = Shader.PropertyToID("_CameraToWorld");
    private static readonly int CameraInverseProjectionMatrixID = Shader.PropertyToID("_CameraInverseProjection");
    ...
    private void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        // Detect structural modifications to clear accumulation history seamlessly
        bool sceneChanged = 
            ...
            !Mathf.Approximately(lightWavelength, _prevLightWavelength) ||
        ...
        if (sceneChanged)
        {
            ...
            _prevLightWavelength = lightWavelength;
        ...
        hybridShader.SetMatrix(CameraToWorldMatrixID, _camera.cameraToWorldMatrix);
        hybridShader.SetMatrix(CameraInverseProjectionMatrixID, _camera.projectionMatrix.inverse);
        ...
        // Build Local-to-World and World-to-Local matrices for the mathematical Prism bounds
