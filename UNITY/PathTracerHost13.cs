...
public class PathTracerHost13 : MonoBehaviour
{
    ...
    [Header("Canvas Painting Settings")]
    [SerializeField] private Vector3 canvasCenter = new Vector3(0.0f, 1.5f, 7.0f);
    [SerializeField] private Vector3 canvasRotation = new Vector3(0.0f, 0.0f, 0.0f);
    [SerializeField] private Vector2 canvasSize = new Vector2(2.4f, 1.8f);
    ...
    // Canvas cache trackers
    private Vector3 _prevCanvasCenter;
    private Vector3 _prevCanvasRotation;
    private Vector2 _prevCanvasSize;
    ...
    private void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        bool sceneChanged = 
            ...
            canvasCenter != _prevCanvasCenter ||
            canvasRotation != _prevCanvasRotation ||
            canvasSize != _prevCanvasSize;
        ...
        if (sceneChanged)
        {
            ...
            _prevCanvasCenter = canvasCenter;
            _prevCanvasRotation = canvasRotation;
            _prevCanvasSize = canvasSize;
        }
        ...
        // Prism Geometry Matrix Generation
        ...
        // Canvas Orientation Directives
        Quaternion canvasRot = Quaternion.Euler(canvasRotation);
        hybridShader.SetVector("_CanvasCenter", canvasCenter);
        hybridShader.SetVector("_CanvasNormal", canvasRot * Vector3.forward);
        hybridShader.SetVector("_CanvasRight", canvasRot * Vector3.right);
        hybridShader.SetVector("_CanvasUp", canvasRot * Vector3.up);
        hybridShader.SetVector("_CanvasHalfExtents", canvasSize * 0.5f);
