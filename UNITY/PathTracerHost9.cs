...
public class PathTracerHost9 : MonoBehaviour
{
    ...
    [Header("Scene Config")]
    [SerializeField] private float planeY = 0.0f; // Control floor grid position dynamically from Inspector
    ...
    // Track previous values to reset accumulation buffer when adjustments happen
    ...
    private static readonly int PlaneYID = Shader.PropertyToID("_PlaneY");
    ...
    private void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        // Reset accumulation if camera moves OR if you adjust properties via UI
        ...
        hybridShader.SetFloat(PlaneYID, planeY); // Dispatched smoothly to uniform
